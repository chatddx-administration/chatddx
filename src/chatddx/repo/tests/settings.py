...
The rest of the project still speaks the old model: the portal's pages
import entities the registry no longer has. So these settings install only
what the registry needs, its own models and the identities and tags its
branches hang off, and history, whose runs read them, under the app label the
